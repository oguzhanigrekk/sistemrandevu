...
export const { handlers, signIn, signOut, auth } = NextAuth({
    providers: [
        Keycloak({
            ...
            issuer: process.env.KEYCLOAK_ISSUER || "https://sistemrandevu.biasdanismanlik.com/auth/realms/kuafor_realm",
            // Specify internal Docker URLs for server-to-server calls to avoid public routing issues
            authorization: `${process.env.KEYCLOAK_ISSUER || "https://sistemrandevu.biasdanismanlik.com/auth/realms/kuafor_realm"}/protocol/openid-connect/auth`,
